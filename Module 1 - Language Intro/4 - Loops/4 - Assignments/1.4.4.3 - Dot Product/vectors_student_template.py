...
### Your code here
for i in range(len(vector_a)):              #creates a for loop that iterates the length of the random vectors
    dot_product+=(vector_a[i]*vector_b[i])  #multiplies the iterative coordinate from each vector and adds the product to the dot product
"""
