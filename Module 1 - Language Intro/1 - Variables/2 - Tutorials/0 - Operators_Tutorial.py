...
one_squared = math.pow(16,2)
two_squared = math.pow(23,2)
...
print("magnitude one is: " + str(magnitude))

# Now, try to do that process all in one step!
magnitude_two = math.sqrt(vector_one **2 + vector_two**2 )
print("magnitude two is: " +str(magnitude_two))
